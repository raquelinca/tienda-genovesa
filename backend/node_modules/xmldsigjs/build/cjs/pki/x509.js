...
class X509Certificate {
    ...
    async Thumbprint(algName = 'SHA-1') {
        return application_js_1.Application.crypto.subtle.digest(algName, this.raw);
    }
    get PublicKey() {
    ...
    async exportKey(algorithm) {
        if (algorithm) {
            ...
            if (alg.algorithm.name.toUpperCase() === ecdsa_sign_js_1.ECDSA) {
    ...
    LoadRaw(rawData) {
        ...
        this.simpl = new pkijs_1.Certificate({ schema: asn1.result });
    }
