import { AssocArray, IXmlSerializable, XmlAttributeType, XmlChildElementType, XmlSchema } from './types.js';
export declare class XmlObject implements IXmlSerializable {
    ...
    IsEmpty(): boolean;
    protected OnLoadXml(_element: Element): void;
    protected GetStatic(): XmlSchema;
    protected GetPrefix(): string;
    protected OnGetXml(_element: Element): void;
