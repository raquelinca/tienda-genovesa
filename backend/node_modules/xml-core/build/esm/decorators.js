...
export function XmlElement(params) {
    return (target) => {
        const t = target;
...
export function XmlChildElement(params = {}) {
...
export function XmlAttribute(params = { required: false, namespaceURI: null }) {
    return (target, propertyKey) => {
        const t = target.constructor;
        const key = propertyKey;
        if (!params.localName) {
...
export function XmlContent(params = { required: false }) {
    return (target, propertyKey) => {
        const t = target.constructor;
        const key = propertyKey;
        if (!t.items) {
